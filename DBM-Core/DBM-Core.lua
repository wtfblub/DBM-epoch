...
DBM = {
	Revision = parseCurseDate("20260117173000"),
	DisplayVersion = "10.1.13 epoch-4", -- the string that is shown as version
	ReleaseRevision = releaseDate(2026, 01, 17) -- the date of the latest stable version that is available, optionally pass hours, minutes, and seconds for multiple releases in one day
}
